...
message_bp.route('/<message>/<int:id_channel>', methods=['POST'])(MessageController.create_message)
message_bp.route('/<int:id_message>', methods=['PUT'])(MessageController.update_message)
